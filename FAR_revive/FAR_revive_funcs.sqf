...
FAR_HandleRevive =
{
        ...
        if (alive _target) then
        {
				...
				sleep 6.5;							//hinzugefügt by Trigger
				player playMove "AinvPknlMstpSlayWrflDnon_medic";		//hinzugefügt by Trigger
				playSound "Inject";						//hinzugefügt by Trigger
				sleep 6.5;							//hinzugefügt by Trigger
				player playMove "AinvPknlMstpSnonWnonDnon_medic_1";		//hinzugefügt by Trigger
				sleep 6.5;							//hinzugefügt by Trigger
				player playMove "AinvPknlMstpSlayWrflDnon_medic";		//hinzugefügt by Trigger
				sleep 6,5;							//hinzugefügt by Trigger
				player playMove "AinvPknlMstpSlayWrflDnon_medic";		//hinzugefügt by Trigger
                ...
                sleep 1;									//Geändert von 6 by Trigger
